...
export const earlyLife = (
  <React.Fragment>
    <p>
      Watts was born to middle-class parents in the village of Chislehurst,
      Kent, on 6 January 1915, living at 3 (now 5) Holbrook Lane, which was
      previously lived in by author John Hemming-Clark in the early 1900s.
      Watts' father, Laurence Wilson Watts, was a representative for the London
      office of the Michelin tyre company. His mother, Emily Mary Watts, was a
      housewife whose father had been a missionary. With modest financial means,
      they chose to live in pastoral surroundings and Watts, an only child, grew
      up playing at Brookside, learning the names of wildflowers and
      butterflies. Probably because of the influence of his mother's religious
      family the Buchans, an interest in "ultimate things" seeped in. It mixed
      with Watts's own interests in storybook fables and romantic tales of the
      mysterious Far East.
    </p>
    <p>
      ...
      fascinated with a certain clarity, transparency, and spaciousness in
      Chinese and Japanese art. It seemed to float..." These works of art
      emphasised the participatory relationship of people in nature, a theme
      that stood fast throughout his life and one that he often wrote about.
      (See, for instance, the last chapter in The Way of Zen.)
    </p>
  </React.Fragment>
);

export const middleYears = (
  <React.Fragment>
    <p>
